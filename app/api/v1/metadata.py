...
API_ROUTES_PREFIX = f'{current.API.PREFIX}/v1'
...
You can access the interactive UI <a href="{API_HOST}{API_ROUTES_PREFIX}{SWAGGER_DOC_PATH}">here</a>.
...
API_GENERAL_TAGS = {
    ...
    'externalDocs': {
        'description': f"""{API_HOST}{API_ROUTES_PREFIX}{SWAGGER_DOC_PATH}""",
        'url': f"""{API_HOST}{API_ROUTES_PREFIX}{SWAGGER_DOC_PATH}"""
    }
}
